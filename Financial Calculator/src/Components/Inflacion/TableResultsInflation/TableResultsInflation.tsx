            ...
            <table className="min-w-full leading-normal">
                <thead>
                    <tr className="bg-gray-200 text-gray-600 text-sm leading-normal">
                        ...
                        <th className="py-2 px-8 sm:py-3 sm:px-6 text-left">Dinero Total Inicial</th>
                        <th className="py-2 px-4 sm:py-3 sm:px-6 text-left">Porcentaje Perdido</th>
                        <th className="py-2 px-2 sm:py-3 sm:px-6 text-left">Dinero Perdido</th>
                    ...
                    {currentRows.map((data) => {
                        ...
                        return (
                            <tr key={data.year} className="border-b border-gray-200 hover:bg-gray-100 text-xs sm:text-sm">
                                ...
                                <td className="py-2 px-5 sm:py-3 sm:px-6 text-left">{(data.inflationLoss + data.valueAfterInflation).toFixed(2)}€</td>
                                <td className="py-2 px-4 sm:py-3 sm:px-6 text-left">{porcentajePerdido.toFixed(2)}%</td>
                                <td className="py-2 px-0 sm:py-3 sm:px-6 text-left">{data.inflationLoss.toFixed(2)}€</td>
                                <td className="py-2 px-2 sm:py-3 sm:px-6 text-left">{data.valueAfterInflation.toFixed(2)}€</td>
                            </tr>
                        );
                    })}
                </tbody>
