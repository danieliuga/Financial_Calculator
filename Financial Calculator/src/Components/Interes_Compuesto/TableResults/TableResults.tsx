            ...
            <table className="min-w-full leading-normal">
                <thead>
                    <tr className="bg-gray-200 text-gray-600 text-sm leading-normal">
                        ...
                        <th className="py-3 px-6 text-left">Dinero Añadido</th>
                        <th className="py-3 px-6 text-left">Total Invertido</th>
                        <th className="py-3 px-6 text-left">Interés Ganado</th>
                        <th className="py-3 px-6 text-left">Dinero Total</th>
                    </tr>
                </thead>
                <tbody>
                    {currentRows.map((data) => (
                        <tr key={data.year} className="border-b border-gray-200 hover:bg-gray-100">
                            ...
                            <td className="py-3 px-6 text-left">{data.totalAdded.toFixed(2)} €</td>
                            <td className="py-3 px-6 text-left">{data.totalInvested.toFixed(2)} €</td>
                            <td className="py-3 px-6 text-left">{data.interestEarned.toFixed(2)} €</td>
                            <td className="py-3 px-6 text-left">{data.totalAmount.toFixed(2)} €</td>
                        </tr>
                    ))}
                </tbody>
            </table>
